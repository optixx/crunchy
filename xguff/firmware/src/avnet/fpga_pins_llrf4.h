...
/* Pin/port assignment specific to LLRF4 board
 * http://recycle.lbl.gov/llrf4/
 *
 *  U2-33  PA0/INT0#                     PROG_B
 *  U2-34  PA1/INT1#                     INIT_B
 *  U2-35  PA2/SLOE                      XERR
 *  U2-36  PA3/WU2                       SLED
 *
 *  U2-37  PA4/FIFOADR0     RN1-8 RN1-1  JTAG_TCK
 *  U2-38  PA5/FIFOADR1     RN1-7 RN1-2  JTAG_TMS
 *  U2-39  PA6/PKTEND       RN1-6 RN1-3  JTAG_TDI
...
sbit at 0x80+4 JTAG_TCK;
sbit at 0x80+5 JTAG_TMS;
sbit at 0x80+6 JTAG_TDI;
sbit at 0x80+7 JTAG_TDO;

/* Output enable bits 6, 5, 4: TCK, TMS, TDI */
/* clash with bmPORT_A_OUTPUTS */
#define JTAG_PORT_SETUP() do { PORTACFG = 0x00; OEA = 0x79; } while (0)
