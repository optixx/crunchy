...
#define VRQ_JTAG_RW			0x83		// wValueL: bit 1 TMS, bit 0 TDI
...
#  define	FL_END_SHUTDOWN			3	// wIndexL: end shutdown cycle, check for success.
							//          stalls endpoint if trouble.

#  define	FL_TX				4	// wIndexL: transfer one bit for TMS, one for TDI
#  define	FL_INIT				5
